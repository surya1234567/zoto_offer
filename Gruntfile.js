...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            js: {
                files: ['<%= myproject.app %>/scripts/{,*/}*.js'],
                options: {
                    livereload: '<%= connect.options.livereload %>'
                }
            },
            livereload: {
                ...
                files: [
                    '<%= myproject.app %>/**/*.html',
                    '.tmp/styles/{,*/}*.css',
                    '<%= myproject.app %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
                ]
            }
        },
        ...
        filerev: {
            dist: {
                src: [
                    '<%= myproject.dist %>/scripts/{,*/}*.js',
                    '<%= myproject.dist %>/styles/{,*/}*.css',
                    '<%= myproject.dist %>/styles/fonts/*'
                ]
            }
        },
        htmlmin: {
